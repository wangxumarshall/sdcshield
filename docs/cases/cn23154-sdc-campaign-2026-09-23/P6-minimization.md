...
| v2d | + FD_GRID→120 96 96 (每元素 12×12×12) | 跑着 (job **1716505**, 11:54 起) | 跑着 | — |
| V3 | + XLSDFT_NSTATES 640→320 | 待跑 | 待跑 | — |
...
频率合规: V1 12/12 窗 + V2 12/12 窗 cpu139 min=1999 / cpu140 min=1997 MHz, 全频 VALID。

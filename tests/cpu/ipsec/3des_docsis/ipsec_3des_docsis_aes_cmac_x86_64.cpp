 ...
 * "-O ipsec_3des_docsis_aes_cmac_x86_64.datasize=N" (1024..64MB, multiple of 16, default 1024). */
...
static int cmac_x86_64_run(struct test *test, int cpu) {
    ...
    struct cmac_x86_64_data local_d;
    ...
    TEST_LOOP(test, 256) {
        ...
        cmac_x86_64_compute_golden(&local_d);
        ...
        memcmp_or_fail(mac, local_d.golden_mac, CMAC_DIGEST_SIZE, "AES-CMAC digest mismatch");
    }
...
static int cmac_x86_64_cleanup(struct test *test) {
    struct cmac_x86_64_data *d = (cmac_x86_64_data *)test->data;
    free(d->plaintext);

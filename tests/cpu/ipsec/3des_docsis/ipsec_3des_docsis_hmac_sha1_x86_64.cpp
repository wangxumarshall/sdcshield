...
static int hmac_sha1_x86_64_run(struct test *test, int cpu) {
    ...
    struct hmac_sha1_x86_64_data local_d;
    ...
    TEST_LOOP(test, 256) {
        ...
        hmac_sha1_x86_64_compute_golden(&local_d);
        ...
        hmac_sha1(local_d.hmac_key, ciphertext, local_d.datasize, mac);
        memcmp_or_fail(mac, local_d.golden_mac, SHA1_DIGEST_SIZE, "HMAC-SHA1 digest mismatch");
    }

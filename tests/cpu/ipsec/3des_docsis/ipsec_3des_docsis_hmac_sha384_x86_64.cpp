 ...
 *
 * @test @b ipsec_3des_docsis_hmac_sha384_x86_64
 * @parblock
 ...
 * "-O ipsec_3des_docsis_hmac_sha384_x86_64.datasize=N" (1024..64MB, multiple of 16, default 1024). */
...
struct hmac_sha384_x86_64_data {
...
static void hmac_sha384_x86_64_compute_golden(struct hmac_sha384_x86_64_data *d) {
...
static int hmac_sha384_x86_64_init(struct test *test) {
    if (s_EVP_CIPHER_CTX_new && s_EVP_EncryptInit_ex && s_EVP_DecryptInit_ex && s_EVP_des_ede3_cbc && s_HMAC_CTX_new && s_EVP_sha384) {
        struct hmac_sha384_x86_64_data *d = (struct hmac_sha384_x86_64_data *)malloc(sizeof(*d));
        ...
        hmac_sha384_x86_64_compute_golden(d);
...
static int hmac_sha384_x86_64_run(struct test *test, int cpu) {
    struct hmac_sha384_x86_64_data *d = (struct hmac_sha384_x86_64_data *)test->data;
...
static int hmac_sha384_x86_64_cleanup(struct test *test) {
    struct hmac_sha384_x86_64_data *d = (hmac_sha384_x86_64_data *)test->data;
    free(d->plaintext);
...
DECLARE_TEST(ipsec_3des_docsis_hmac_sha384_x86_64, "Intel IPSEC 3DES-DOCSIS w/ HMAC-SHA384 X86_64")
    .groups = DECLARE_TEST_GROUPS(&group_ipsec),
    .test_init = hmac_sha384_x86_64_init,
    .test_run = hmac_sha384_x86_64_run,
    .test_cleanup = hmac_sha384_x86_64_cleanup,

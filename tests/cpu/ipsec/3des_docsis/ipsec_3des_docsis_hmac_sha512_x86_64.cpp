 ...
 * "-O ipsec_3des_docsis_hmac_sha512_x86_64.datasize=N" (1024..64MB, multiple of 16, default 1024). */
...
static int hmac_sha512_x86_64_run(struct test *test, int cpu) {
    ...
    struct hmac_sha512_x86_64_data local_d;
    ...
    TEST_LOOP(test, 256) {
        ...
        hmac_sha512_x86_64_compute_golden(&local_d);
        ...
        memcmp_or_fail(mac, local_d.golden_mac, SHA512_DIGEST_SIZE, "HMAC-SHA512 digest mismatch");
    }
...
static int hmac_sha512_x86_64_cleanup(struct test *test) {
    struct hmac_sha512_x86_64_data *d = (hmac_sha512_x86_64_data *)test->data;
    free(d->plaintext);

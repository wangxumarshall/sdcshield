 ...
 *
 * @test @b ipsec_aes128_cbc_hmac_sha1_sse
 * @parblock
...
static int hmac_sha1_sse_run(struct test *test, int cpu) {
    ...
    struct hmac_sha1_sse_data local_d;
    ...
    TEST_LOOP(test, 256) {
        ...
        hmac_sha1_sse_compute_golden(&local_d);
        ...
        memcmp_or_fail(mac, local_d.golden_mac, SHA1_96_DIGEST_SIZE, "HMAC-SHA1-96 digest mismatch (SSE)");
    }
...
DECLARE_TEST(ipsec_aes128_cbc_hmac_sha1_sse, "Intel IPSEC AES128-CBC w/ HMAC_SHA1-96 SSE")
    .groups = DECLARE_TEST_GROUPS(&group_ipsec),
    .test_init = hmac_sha1_sse_init,
    .test_run = hmac_sha1_sse_run,
    .test_cleanup = hmac_sha1_sse_cleanup,

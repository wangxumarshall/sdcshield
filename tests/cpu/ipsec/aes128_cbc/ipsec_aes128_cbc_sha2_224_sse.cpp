 ...
 *
 * @test @b ipsec_aes128_cbc_sha2_224_sse
 * @parblock
...
static int sha2_224_sse_run(struct test *test, int cpu) {
    ...
    struct sha2_224_sse_data local_d;
    ...
    TEST_LOOP(test, 256) {
        ...
        sha2_224_sse_compute_golden(&local_d);
        ...
        memcmp_or_fail(mac, local_d.golden_mac, SHA224_DIGEST_SIZE, "HMAC-SHA224 digest mismatch (SSE)");
    }
...
DECLARE_TEST(ipsec_aes128_cbc_sha2_224_sse, "Intel IPSEC AES128-CBC SHA2_224 SSE")
    .groups = DECLARE_TEST_GROUPS(&group_ipsec),
    .test_init = sha2_224_sse_init,
    .test_run = sha2_224_sse_run,
    .test_cleanup = sha2_224_sse_cleanup,

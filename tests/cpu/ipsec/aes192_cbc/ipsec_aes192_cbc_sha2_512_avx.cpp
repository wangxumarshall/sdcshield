 ...
 *
 * @test @b ipsec_aes192_cbc_sha2_512_avx
 * @parblock
 ...
 * "-O ipsec_aes192_cbc_sha2_512_avx.datasize=N" (1024..64MB, multiple of 16, default 1024). */
...
DECLARE_TEST(ipsec_aes192_cbc_sha2_512_avx, "Intel IPSEC AES192-CBC SHA2_512 AVX")

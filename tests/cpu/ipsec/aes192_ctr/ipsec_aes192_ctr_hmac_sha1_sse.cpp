 ...
 *
 * @test @b ipsec_aes192_ctr_hmac_sha1_sse
 * @parblock
 ...
 * "-O ipsec_aes192_ctr_hmac_sha1_sse.datasize=N" (1024..64MB, multiple of 16, default 1024). */
...
DECLARE_TEST(ipsec_aes192_ctr_hmac_sha1_sse, "Intel IPSEC AES192-CTR w/ HMAC_SHA1-96 SSE")

 ...
 *
 * @test @b ipsec_aes192_ctr_hmac_sha384_sse
 * @parblock
 ...
 * "-O ipsec_aes192_ctr_hmac_sha384_sse.datasize=N" (1024..64MB, multiple of 16, default 1024). */
...
DECLARE_TEST(ipsec_aes192_ctr_hmac_sha384_sse, "Intel IPSEC AES192-CTR w/ HMAC SHA-384 SSE")

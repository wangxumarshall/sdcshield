 ...
 *
 * @test @b ipsec_3des_docsis_aes_cmac_sve_wide
 * @parblock
...
DECLARE_TEST(ipsec_3des_docsis_aes_cmac_sve_wide, "Intel IPSEC SVE port: 3DES-DOCSIS w/ AES-CMAC (compute path: OpenSSL EVP; port of the avx-named original)")
